function[transPKApwAct, transSnf1pwAct, transTORpwAct, transEnzymesAct, transTargetsAct] = ...
...
if iteration == 1
    transPKApwAct = [table(PKApwOld{:,1}), activity];
else
    transPKApwAct = [transPKApwAct, activity];
end
...
if iteration == 1
    transSnf1pwAct = [table(Snf1pwOld{:,1}), activity];
else
    transSnf1pwAct = [transSnf1pwAct, activity];
end
...
if iteration == 1
    transTORpwAct = [table(TORpwOld{:,1}), activity];
else
    transTORpwAct = [transTORpwAct, activity];
end
...
if iteration == 1
    transEnzymesAct = [table(EnzymesOld{:,1}), activity];
else
    transEnzymesAct = [transEnzymesAct, activity];
end
