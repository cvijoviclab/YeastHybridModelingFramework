function [Metabolites, PKApw, Snf1pw, TORpw, Enzymes, Targets, transTFAct] = ...
    reachSteadyState(MetabolitesIn, PKApwIn, Snf1pwIn, TORpwIn, EnzymesIn, TargetsIn, glucoseLevel, nitrogenLevel, path, activeCrosstalk)
...
writetable(Metabolites, [path, 'Metabolites_SS.txt'], 'Delimiter', '\t');
writetable(PKApw, [path, 'PKApw_SS.txt'], 'Delimiter', '\t');
writetable(Snf1pw, [path, 'Snf1pw_SS.txt'], 'Delimiter', '\t');
writetable(TORpw, [path, 'TORpw_SS.txt'], 'Delimiter', '\t');
writetable(Enzymes, [path, 'Enzymes_SS.txt'], 'Delimiter', '\t');
...
writetable(transPKApwAct, [path, 'Activity/Transitions/', 'transPKApw.txt'], 'Delimiter', '\t');
writetable(transSnf1pwAct, [path, 'Activity/Transitions/', 'transSnf1pw.txt'], 'Delimiter', '\t');
writetable(transTORpwAct, [path, 'Activity/Transitions/', 'transTORpw.txt'], 'Delimiter', '\t');
writetable(transEnzymesAct, [path, 'Activity/Transitions/', 'transEnzymes.txt'], 'Delimiter', '\t');
