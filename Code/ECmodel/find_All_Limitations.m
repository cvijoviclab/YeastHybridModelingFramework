function [limTable,breakFlag] = find_All_Limitations(model,prevUnicodes,topLim,option)
%find_All_Limitations
%
...
% if any.
%
% Ivan Domenzain    Last edited. 2020-04-22
...
variables = {'enzyme' 'enzMet_index' 'rxn_index' 'kcat' 'ECC' 'rxnName'};
limTable = table(limKcats{1},limKcats{2},limKcats{3},limKcats{4},...
                 limKcats{5},limKcats{6},'VariableNames',variables);
