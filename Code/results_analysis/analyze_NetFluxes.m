...
writetable(results,[resultsPath '/netFlux_respiration.txt'],'delimiter','\t','QuoteStrings',false);
variables = {'rxns' 'rxnNames' 'netFlux' 'ratio' 'futileFlux' 'netFlux_reg' 'ratio_reg' 'futileFlux_reg'};
...
writetable(results,[resultsPath '/netFlux_fermentation.txt'],'delimiter','\t','QuoteStrings',false);
end