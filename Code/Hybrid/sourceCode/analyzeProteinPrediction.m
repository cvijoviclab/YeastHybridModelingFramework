%function []=analyzeProteinPrediction(GeneExpr,prot_abundance_resp, prot_abundance_ferm)
...
disp(['The Pearson correlation coefficients for the unregulated model is ' num2str(rCoeffRespiration)]);
disp(['The Pearson correlation coefficients for the regulated model is ' num2str(rCoeffRespirationR)]);
